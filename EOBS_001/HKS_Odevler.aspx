<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HKS_Odevler.aspx.cs" Inherits="EOBS_001.HKS_Odevler" %>
    ...
    <div class="main_container container_16 clearfix full_size">
		<div class="box grid_16">
            ...
            <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Skin="Default"></telerik:RadAjaxLoadingPanel>
               <telerik:RadGrid ID="GridDamla" runat="server" CellSpacing="0"  GridLines="None" AllowPaging="True" Skin="WebBlue" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" DataSourceID="EDS_Odevler" >
            ...
            <PagerStyle Mode="NextPrev" FirstPageToolTip="İlk Sayfa" LastPageToolTip="Son Sayfa" NextPagesToolTip="Sonraki Sayfalar" NextPageToolTip="Sonraki Sayfa" PagerTextFormat="{4}Gösterilen: <strong>{2}</strong>-<strong>{3}</strong> Toplam: <strong>{5}</strong>" PageSizeLabelText="Satır Sayısı:" PrevPagesToolTip="Önceki Sayfalar" PrevPageToolTip="Önceki Sayfa"  />
                <MasterTableView DataSourceID="EDS_Odevler" AutoGenerateColumns="False" CommandItemSettings-AddNewRecordText="Yeni Ödev Ekle" CommandItemSettings-RefreshText="Yenile" CommandItemSettings-ExportToExcelText="Excell" CommandItemDisplay="Top" DataKeyNames="ODV_ID" NoMasterRecordsText="Kayıt Yok">
...
<ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="ODV_ID" DataType="System.Int32" HeaderText="ODV_ID" ReadOnly="True" UniqueName="ODV_ID" Visible="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ODV_AD" HeaderText="ADI" UniqueName="ODV_AD">
                        </telerik:GridBoundColumn>
                        <%--<telerik:GridBoundColumn DataField="ODV_METIN"  HeaderText="METİN" UniqueName="ODV_METIN">     
                        </telerik:GridBoundColumn>--%>
                        ...
                        <telerik:GridTemplateColumn DataField="ODV_METIN"  HeaderText="METİN" UniqueName="ODV_METIN" Visible="false" >
                            <InsertItemTemplate>
                                <telerik:RadTextBox ID="Temp2"  runat="server" Text='<% #Bind("ODV_METIN") %>' TextMode="MultiLine" Width="600" Height="400" />
                                
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Temp1" runat="server" Text='<% #Bind("ODV_METIN") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="Temp3"  runat="server" Text='<% #Bind("ODV_METIN") %>' TextMode="MultiLine" Width="600" Height="300" />
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
                        <%--<telerik:GridHTMLEditorColumn DataField="ODV_METIN" HeaderText="METİN" UniqueName="ODV_METIN">
            ...
            <StatusBarSettings LoadingText="Yükleniyor..." ReadyText="Hazır" />
                ...
                <asp:EntityDataSource ID="EDS_Odevler" runat="server" ConnectionString="name=EOBSEntities" DefaultContainerName="EOBSEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="ODEVLER" EntityTypeFilter="ODEVLER" OnDeleted="EDS_Odevler_Deleted" OnInserted="EDS_Odevler_Inserted" OnUpdated="EDS_Odevler_Updated" AutoGenerateWhereClause="True" Where="" OnInserting="EDS_Odevler_Inserting" OnUpdating="EDS_Odevler_Inserting" >
                    <WhereParameters>
