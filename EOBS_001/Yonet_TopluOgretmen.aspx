<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Yonet_TopluOgretmen.aspx.cs" Inherits="EOBS_001.Yonet_TopluOgretmen" %>
<asp:Content ID="ContentTopluOgretmen" ContentPlaceHolderID="MainContent" runat="server">
      <div class="main_container container_16 clearfix full_size">
		<div class="box grid_16">
			<h2 class="box_head">Toplu Ogretmen Ekle<span></span></h2>
			<div class="controls">
