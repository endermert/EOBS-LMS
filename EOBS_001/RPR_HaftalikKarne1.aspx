<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RPR_HaftalikKarne1.aspx.cs" Inherits="EOBS_001.RPR_HaftalikKarne1" %>
...
<asp:Content ID="ContentRPRHaftalikKarne" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="main_container container_16 clearfix full_size">
		<div class="box grid_16">
            ...
            <LocalReport ReportPath="RPR_HaftalikKarne1.rdlc"  >
...
ORDER BY OZELNOT.OZN_TAR DESC">
        ...
        <asp:SqlDataSource ID="SDS_Devamsiz" runat="server" ConnectionString="<%$ ConnectionStrings:EOBS_001ConnectionString %>" SelectCommand="SELECT KUL_ID, DVM_AD, DVM_GUN, DVM_MAZERET, DVM_TAR FROM DEVAMSIZ WHERE (OKL_ID = @OKL_ID) AND (HFT_ID = @HFT_ID)">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="HFT_ID" />
                <asp:Parameter DefaultValue="3" Name="OKL_ID" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SDS_Davranis" runat="server" ConnectionString="<%$ ConnectionStrings:EOBS_001ConnectionString %>" SelectCommand="SELECT DAVRANIS.KUL_ID, DAVRANIS.DAV_AD, DAVRANIS.DAV_TAR, KULLANICILAR.KUL_AD FROM DAVRANIS INNER JOIN KULLANICILAR ON DAVRANIS.DAV_KULID = KULLANICILAR.KUL_ID WHERE (DAVRANIS.HFT_ID = @HFT_ID) AND (DAVRANIS.OKL_ID = @OKL_ID) ORDER BY DAVRANIS.DAV_TAR DESC">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="HFT_ID" />
                <asp:Parameter DefaultValue="3" Name="OKL_ID" />
            </SelectParameters>
