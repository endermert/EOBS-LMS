...
namespace EOBS_001
{
    public partial class RPR_HaftalikKarne1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ref1"] != null)
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    SDS_Devamsiz.SelectParameters.Add("HFT_ID", System.Data.DbType.Int32, HFT_ID.ToString());
                    ...
                    SDS_Davranis.SelectParameters.Add("HFT_ID", System.Data.DbType.Int32, HFT_ID.ToString());
        ...
        protected void bnt_raporla_Click(object sender, EventArgs e)
        {
                ...
                if (cb_Hafta.SelectedIndex != -1)
                {
                    ...
                    if (cb_Kul.SelectedIndex!=-1)
                        Response.Redirect("RPR_HaftalikKarne1.aspx?ref1="+cb_Hafta.SelectedValue+"&ref4=" + cb_Kul.SelectedValue);
                    else
                        if (cb_Sube.SelectedIndex!=-1)
                            Response.Redirect("RPR_HaftalikKarne1.aspx?ref1=" + cb_Hafta.SelectedValue + "&ref3=" + cb_Sube.SelectedValue);
                        else
                            if (cb_Sinif.SelectedIndex!=-1)
                                Response.Redirect("RPR_HaftalikKarne1.aspx?ref1=" + cb_Hafta.SelectedValue + "&ref2=" + cb_Sinif.SelectedValue);

                    if (cb_Kul.SelectedIndex == -1 && cb_Sube.SelectedIndex == -1 && cb_Sinif.SelectedIndex == -1)
                    {
                        Response.Redirect("RPR_HaftalikKarne1.aspx?ref1=" + cb_Hafta.SelectedValue);
                    }
        ...
        protected void btn_RaporlaOgr_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("RPR_HaftalikKarne1.aspx?ref1=" + cb_HaftaOgr.SelectedValue + "&ref4=" + Session["KulId"].ToString());
            }
        }
