<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RPR_SinavSonuc1.aspx.cs" Inherits="EOBS_001.RPR_SinavSonuc1" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<asp:Content ID="ContentSinavSonuc" ContentPlaceHolderID="MainContent" runat="server">
    <telerik:RadScriptManager ID="RadScriptManager1" Runat="server" />
    <asp:Panel runat="server" ID="Panel2">
     <div class="main_container container_16 clearfix full_size">
		<div class="box grid_16">
			<h2 class="box_head">SINAV SONUC RAPORU PARAMETRELERi<span></span></h2>
			<div class="controls">
                ...
                <div style="margin:10px;">
                    <asp:Table ID="Table1" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell ColumnSpan="3">
                                <asp:Label runat="server" ID="Label3" Text="CEVAP TABLOSU GİZLE :"></asp:Label>
                                <asp:CheckBox runat="server" ID="chkCvp" />
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell>
			...
			<div class="toggle_container">
                <div style="margin:10px;">
                    <asp:Table ID="Table2" runat="server">
                        <asp:TableRow>
                            <asp:TableCell>
                                <asp:Label runat="server" ID="Label1" Text="SINAV :"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell>
                                <telerik:RadComboBox ID="cb_SinavOgr" Runat="server" Skin="WebBlue" DataSourceID="SDS_Sinavlar1" DataTextField="SNV_AD" DataValueField="SNV_ID" EmptyMessage="SEÇİNİZ.." Width="250" ></telerik:RadComboBox>
                            </asp:TableCell>
                            <asp:TableCell>
    ...
    <div class="main_container container_16 clearfix full_size">
		<div class="box grid_16">
			<h2 class="box_head">SINAV SONUC RAPORU<span></span></h2>
			<div class="controls">
				<a href="#" class="grabber"></a>
				<a href="#" class="toggle"></a>
			</div>
            ...
            <LocalReport ReportPath="RPR_SinavSonuc1.rdlc"  >
            </LocalReport>
        </rsweb:ReportViewer>
       ...
       <asp:SqlDataSource ID="SDS_DersSnc" runat="server" ConnectionString="<%$ ConnectionStrings:EOBS_001ConnectionString %>" SelectCommand="SELECT DRSSNVSNC.DSN_ID, DRSSNVSNC.SNV_ID, DRSSNVSNC.KUL_ID, DERSLER.DRS_AD, DRSSNVSNC.DSN_SS, DRSSNVSNC.DSN_DS, DRSSNVSNC.DSN_YS, DRSSNVSNC.DSN_NS, DRSSNVSNC.DSN_ORTSUB, DRSSNVSNC.DSN_SRASUB, DRSSNVSNC.DSN_TOPSUB, DRSSNVSNC.DSN_ORTSNF, DRSSNVSNC.DSN_SRASNF, DRSSNVSNC.DSN_TOPSNF, DRSSNVSNC.DSN_ORTOKL, DRSSNVSNC.DSN_SRAOKL, DRSSNVSNC.DSN_TOPOKL, DRSSNVSNC.DSN_BSRYZD, DRSSNVSNC.DSN_BSRYRM, DRSSNVSNC.DSN_KTPCK, DRSSNVSNC.DSN_CVPANH, DRSSNVSNC.DSN_CVPKUL, DRSSNVSNC.DSN_CVPAE FROM DRSSNVSNC INNER JOIN DERSLER ON DRSSNVSNC.DRS_ID = DERSLER.DRS_ID WHERE (DRSSNVSNC.SNV_ID = @SNV_ID)">
        ...
        <asp:SqlDataSource ID="SDS_SnvSncKul" runat="server" ConnectionString="<%$ ConnectionStrings:EOBS_001ConnectionString %>" SelectCommand="SELECT KULLANICILAR.KUL_ID, KULLANICILAR.KUL_NO, SUBELER.SUB_AD, KULLANICILAR.OKL_ID, KULLANICILAR.KUL_ISIM, KULLANICILAR.KUL_SOYISIM, KULLANICILAR.KUL_SIFRE, SINAVLAR.SNV_ID, SINAVLAR.SNV_AD, SINAVSNC.SNS_SS, SINAVSNC.SNS_DS, SINAVSNC.SNS_YS, SINAVSNC.SNS_NS, SINAVSNC.SNS_PUAN, SINAVSNC.SNS_ORTSUB, SINAVSNC.SNS_SRASUB, SINAVSNC.SNS_TOPSUB, SINAVSNC.SNS_ORTSNF, SINAVSNC.SNS_SRASNF, SINAVSNC.SNS_TOPSNF, SINAVSNC.SNS_ORTOKL, SINAVSNC.SNS_SRAOKL, SINAVSNC.SNS_TOPOKL, SINAVSNC.SNS_BSRYZD, SINAVSNC.SNS_BSRYRM, SINAVSNC.SNS_YGS1, SINAVSNC.SNS_YGS2, SINAVSNC.SNS_YGS3, SINAVSNC.SNS_YGS4, SINAVSNC.SNS_YGS5, SINAVSNC.SNS_YGS6, SINAVSNC.SNS_MF1, SINAVSNC.SNS_MF2, SINAVSNC.SNS_MF3, SINAVSNC.SNS_MF4, SINAVSNC.SNS_TM1, SINAVSNC.SNS_TM3, SINAVSNC.SNS_TM2, SINAVSNC.SNS_TS1, SINAVSNC.SNS_TS2, SINAVSNC.SNS_DIL1, SINAVSNC.SNS_DIL2 FROM KULLANICILAR INNER JOIN SUBELER ON KULLANICILAR.SUB_ID = SUBELER.SUB_ID INNER JOIN SINAVSNC ON KULLANICILAR.KUL_ID = SINAVSNC.KUL_ID INNER JOIN SINAVLAR ON SINAVSNC.SNV_ID = SINAVLAR.SNV_ID WHERE (KULLANICILAR.OKL_ID = @OKL_ID) AND (SINAVLAR.SNV_ID = @SNV_ID) AND (SINAVLAR.SNV_DEG = 1)">
            <SelectParameters>
