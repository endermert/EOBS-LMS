<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HKS_OzelNotlar.aspx.cs" Inherits="EOBS_001.HKS_OzelNotlar1" %>
<asp:Content ID="ContentOzelNotlar" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main_container container_16 clearfix full_size">
		<div class="box grid_16">
            ...
            <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Skin="Default"></telerik:RadAjaxLoadingPanel>
               <telerik:RadGrid ID="GridDamla" runat="server" CellSpacing="0"  GridLines="None" AllowPaging="True" Skin="WebBlue" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" DataSourceID="EDS_OzelNotlar" OnSelectedIndexChanged="GridDamla_SelectedIndexChanged" >
            ...
            <PagerStyle Mode="NextPrev" FirstPageToolTip="İlk Sayfa" LastPageToolTip="Son Sayfa" NextPagesToolTip="Sonraki Sayfalar" NextPageToolTip="Sonraki Sayfa" PagerTextFormat="{4}Gösterilen: <strong>{2}</strong>-<strong>{3}</strong> Toplam: <strong>{5}</strong>" PageSizeLabelText="Satır Sayısı:" PrevPagesToolTip="Önceki Sayfalar" PrevPageToolTip="Önceki Sayfa"  />
                <MasterTableView DataSourceID="EDS_OzelNotlar" AutoGenerateColumns="False" CommandItemSettings-AddNewRecordText="Yeni Damlacık Ekle" CommandItemSettings-RefreshText="Yenile" CommandItemSettings-ExportToExcelText="Excell" CommandItemDisplay="Top" DataKeyNames="OZL_ID" NoMasterRecordsText="Kayıt Yok">
    
<CommandItemSettings AddNewRecordText="Yeni Not Ekle" RefreshText="Yenile" ExportToExcelText="Excell" ExportToPdfText="Export to PDF"></CommandItemSettings>
...
<ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="OZL_ID" DataType="System.Int32" HeaderText="OZL_ID" ReadOnly="True" UniqueName="OZL_ID" Visible="false">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="OZL_AD" HeaderText="ADI" UniqueName="OZL_AD">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn DataField="OZL_METIN"  HeaderText="METİN" UniqueName="OZL_METIN" Visible="false" >
                            <InsertItemTemplate>
                                <telerik:RadTextBox ID="Temp2"  runat="server" Text='<% #Bind("OZL_METIN") %>' TextMode="MultiLine" Width="600" Height="100" />
                                <br />
                                <asp:Label ID="Temp21" runat="server" Text="*Bu metin karnede çıkmaz, size hatırlatma amaçlıdır." />
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Temp1" runat="server" Text='<% #Bind("OZL_METIN") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="Temp3"  runat="server" Text='<% #Bind("OZL_METIN") %>' TextMode="MultiLine" Width="600" Height="100" />
                                <br />
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
                ...
                <asp:EntityDataSource ID="EDS_OzelNotlar" runat="server" ConnectionString="name=EOBSEntities" DefaultContainerName="EOBSEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="OZELNOTLAR" EntityTypeFilter="OZELNOTLAR"  AutoGenerateWhereClause="True" Where="" OnDeleted="EDS_OzelNotlar_Deleted" OnInserted="EDS_OzelNotlar_Inserted" OnUpdated="EDS_OzelNotlar_Updated" OnInserting="EDS_OzelNotlar_Inserting" OnUpdating="EDS_OzelNotlar_Inserting">
                    <WhereParameters>
