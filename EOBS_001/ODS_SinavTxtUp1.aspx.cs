...
namespace EOBS_001
{
    public partial class ODS_SinavTxtUp1 : System.Web.UI.Page
    {
        int SNV_ID=0;
        private DataTable table;
        private DataTable HesapTablo;
        private List<DRSSNVSNC> DersSonuc;
                ...
                if (txtup.PostedFile.ContentType == "text/plain")
                {
                    if (txtup.PostedFile.ContentLength < 1002400)
                    {
                        ...
                        if (snv != null)
                        {
                            ...
                            StreamReader reader = new StreamReader(yol,Encoding.GetEncoding(1254));
                            ...
                            while (!reader.EndOfStream)
                            {
                                ...
                                if (satir == "") break;
                                string ad = satir.Substring((short)snv.SINAVDETAY.OPTIK.OPT_AD_BAS - 1, (short)snv.SINAVDETAY.OPTIK.OPT_AD_UZN);
                                string soyad = satir.Substring((short)snv.SINAVDETAY.OPTIK.OPT_SOY_BAS - 1, (short)snv.SINAVDETAY.OPTIK.OPT_SOY_UZN);
                                ...
                                { 
                                    case 1:
                                        table.Rows.Add(syc.ToString(),"H", oklKod,ad,soyad, ogrNo, tcNo, kitapcik, cvpD1);
                                        break;
                                    case 2:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2);
                                        break;
                                    case 3:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3);
                                        break;
                                    case 4:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4);
                                        break;
                                    case 5:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5);
                                        break;
                                    case 6:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6);
                                        break;
                                    case 7:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7);
                                        break;
                                    case 8:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8);
                                        break;
                                    case 9:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9);
                                        break;
                                    case 10:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9, cvpD10);
                                        break;
                                    case 11:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9, cvpD10, cvpD11);
                                        break;
                                    case 12:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9, cvpD10, cvpD11, cvpD12);
                                        break;
                                    case 13:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9, cvpD10, cvpD11, cvpD12, cvpD13);
                                        break;
                                    case 14:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9, cvpD10, cvpD11, cvpD12, cvpD13, cvpD14);
                                        break;
                                    case 15:
                                        table.Rows.Add(syc.ToString(), "H", oklKod, ad, soyad, ogrNo, tcNo, kitapcik, cvpD1, cvpD2, cvpD3, cvpD4, cvpD5, cvpD6, cvpD7, cvpD8, cvpD9, cvpD10, cvpD11, cvpD12, cvpD13, cvpD14, cvpD15);
                                        break;
                                }
        ...
        protected void btn_Kaydet2_Click(object sender, EventArgs e)
        {
            DataTable dt = null;
            if (Session["DataTable"] != null)
        ...
        protected void btn_Kaydet_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null && snv != null)
            {
                ...
                HesapTablo = new DataTable();
                HesapTablo.Columns.Add("KUL_ID", typeof(int));
                HesapTablo.Columns.Add("SUB_AD", typeof(string));
                HesapTablo.Columns.Add("KUL_NO", typeof(string));
                HesapTablo.Columns.Add("KUL_TCNO", typeof(string));
                HesapTablo.Columns.Add("KUL_ISIM", typeof(string));
                HesapTablo.Columns.Add("KUL_SOYISIM", typeof(string));
                HesapTablo.Columns.Add("DSN_KTPCK", typeof(string));
                HesapTablo.Columns.Add("DRS_AD", typeof(string));
                HesapTablo.Columns.Add("DSN_DS", typeof(string));
                HesapTablo.Columns.Add("DSN_YS", typeof(string));
                HesapTablo.Columns.Add("DSN_BS", typeof(string));
                HesapTablo.Columns.Add("DSN_NS", typeof(string));
                HesapTablo.Columns.Add("SNS_DS", typeof(string));
                HesapTablo.Columns.Add("SNS_YS", typeof(string));
                HesapTablo.Columns.Add("SNS_BS", typeof(string));
                HesapTablo.Columns.Add("SNS_NS", typeof(string));
                HesapTablo.Columns.Add("SNS_PUAN", typeof(string));
                HesapTablo.Columns.Add("SNS_BSRYZD", typeof(string));
                HesapTablo.Columns.Add("SNV_AD", typeof(string));
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    //try
                    //{
                    Object []prms=new Object[19];
                    prms[0]=i.ToString();
                    prms[1]=" ";
                    prms[2] = dt.Rows[i][5].ToString();
                    prms[3] = dt.Rows[i][6].ToString();
                    prms[4] = dt.Rows[i][3].ToString();
                    prms[5] = dt.Rows[i][4].ToString();
                    prms[6] = dt.Rows[i][7].ToString();
                    

                    //ogrNo = int.Parse(dt.Rows[i][5].ToString().Trim());
                    TCKimlik = dt.Rows[i][6].ToString().Trim();
                    Kitapcik = dt.Rows[i][7].ToString().Trim();
                    ...
                    if (1 == 1)
                    {
                        ...
                        DersSonuc = new List<DRSSNVSNC>();
                        #region DERSLER
                        if (snv.SINAVDETAY.DERSLER != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS0SS, SNV_ID, snv.SINAVDETAY.DERSLER.DRS_ID, Kitapcik, dt.Rows[i][8].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS0KS, snv.SINAVDETAY.DERSLER.DRS_AD);
                        }
                        #endregion
                        #region DERSLER1
                        if (snv.SINAVDETAY.DERSLER1 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS1SS, SNV_ID, snv.SINAVDETAY.DERSLER1.DRS_ID, Kitapcik, dt.Rows[i][9].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS1KS, snv.SINAVDETAY.DERSLER1.DRS_AD);
                        }
                        #endregion
                        #region DERSLER2
                        if (snv.SINAVDETAY.DERSLER2 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS2SS, SNV_ID, snv.SINAVDETAY.DERSLER2.DRS_ID, Kitapcik, dt.Rows[i][10].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS2KS, snv.SINAVDETAY.DERSLER2.DRS_AD);
                        }
                        #endregion
                        #region DERSLER3
                        if (snv.SINAVDETAY.DERSLER3 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS3SS, SNV_ID, snv.SINAVDETAY.DERSLER3.DRS_ID, Kitapcik, dt.Rows[i][11].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS3KS, snv.SINAVDETAY.DERSLER3.DRS_AD);
                        }
                        #endregion
                        #region DERSLER4
                        if (snv.SINAVDETAY.DERSLER4 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS4SS, SNV_ID, snv.SINAVDETAY.DERSLER4.DRS_ID, Kitapcik, dt.Rows[i][12].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS4KS, snv.SINAVDETAY.DERSLER4.DRS_AD);
                        }
                        #endregion
                        #region DERSLER5
                        if (snv.SINAVDETAY.DERSLER5 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS5SS, SNV_ID, snv.SINAVDETAY.DERSLER5.DRS_ID, Kitapcik, dt.Rows[i][13].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS5KS, snv.SINAVDETAY.DERSLER5.DRS_AD);
                        }
                        #endregion
                        #region DERSLER6
                        if (snv.SINAVDETAY.DERSLER6 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS6SS, SNV_ID, snv.SINAVDETAY.DERSLER6.DRS_ID, Kitapcik, dt.Rows[i][14].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS6KS, snv.SINAVDETAY.DERSLER6.DRS_AD);
                        }
                        #endregion
                        #region DERSLER7
                        if (snv.SINAVDETAY.DERSLER7 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS7SS, SNV_ID, snv.SINAVDETAY.DERSLER7.DRS_ID, Kitapcik, dt.Rows[i][15].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS7KS, snv.SINAVDETAY.DERSLER7.DRS_AD);
                        }
                        #endregion
                        #region DERSLER8
                        if (snv.SINAVDETAY.DERSLER8 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS8SS, SNV_ID, snv.SINAVDETAY.DERSLER8.DRS_ID, Kitapcik, dt.Rows[i][16].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS8KS, snv.SINAVDETAY.DERSLER8.DRS_AD);
                        }
                        #endregion
                        #region DERSLER9
                        if (snv.SINAVDETAY.DERSLER9 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS9SS, SNV_ID, snv.SINAVDETAY.DERSLER9.DRS_ID, Kitapcik, dt.Rows[i][17].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS9KS, snv.SINAVDETAY.DERSLER9.DRS_AD);
                        }
                        #endregion
                        #region DERSLER10
                        if (snv.SINAVDETAY.DERSLER10 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS10SS, SNV_ID, snv.SINAVDETAY.DERSLER10.DRS_ID, Kitapcik, dt.Rows[i][18].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS10KS, snv.SINAVDETAY.DERSLER10.DRS_AD);
                        }
                        #endregion
                        #region DERSLER11
                        if (snv.SINAVDETAY.DERSLER11 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS11SS, SNV_ID, snv.SINAVDETAY.DERSLER11.DRS_ID, Kitapcik, dt.Rows[i][19].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS11KS, snv.SINAVDETAY.DERSLER11.DRS_AD);
                        }
                        #endregion
                        #region DERSLER12
                        if (snv.SINAVDETAY.DERSLER12 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS12SS, SNV_ID, snv.SINAVDETAY.DERSLER12.DRS_ID, Kitapcik, dt.Rows[i][20].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS12KS, snv.SINAVDETAY.DERSLER12.DRS_AD);
                        }
                        #endregion
                        #region DERSLER13
                        if (snv.SINAVDETAY.DERSLER13 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS13SS, SNV_ID, snv.SINAVDETAY.DERSLER13.DRS_ID, Kitapcik, dt.Rows[i][21].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS13KS, snv.SINAVDETAY.DERSLER13.DRS_AD);
                        }
                        #endregion
                        #region DERSLER14
                        if (snv.SINAVDETAY.DERSLER14 != null)
                        {
                            Hesapla2(entity, snv, (short)snv.SINAVDETAY.SDT_DRS14SS, SNV_ID, snv.SINAVDETAY.DERSLER14.DRS_ID, Kitapcik, dt.Rows[i][22].ToString(), (Decimal)snv.SINAVDETAY.SDT_DRS14KS, snv.SINAVDETAY.DERSLER14.DRS_AD);
                        }
                        ...
                        int NS = 0;
                        decimal Puan = 0;
                        for (int j = 0; j < DersSonuc.Count; j++)
                        {
                            DS = DS + (short)DersSonuc[j].DSN_DS;
                            YS = YS + (short)DersSonuc[j].DSN_YS;
                            BS = BS + (short)DersSonuc[j].DSN_BS;
                            NS = NS + (short)DersSonuc[j].DSN_NS;
                            Puan = Puan + (decimal)DersSonuc[j].DSN_PUAN;
                        }

                        for (int j = 0; j < DersSonuc.Count; j++)
                        {
                            prms[7] = DersSonuc[j].DSN_BSRYRM;
                            prms[8] = DersSonuc[j].DSN_DS.ToString();
                            prms[9] = DersSonuc[j].DSN_YS.ToString();
                            prms[10] = DersSonuc[j].DSN_BS.ToString();
                            prms[11] = DersSonuc[j].DSN_NS.ToString();
                            prms[12] = DS;
                            prms[13] = YS;
                            prms[14] = BS;
                            prms[15] = NS;
                            prms[16] = snv.SINAVDETAY.SDT_TABPUAN+Puan;
                            prms[17] = ((snv.SINAVDETAY.SDT_TABPUAN + Puan)*100)/500;
                            prms[18] = snv.SNV_AD;
                            HesapTablo.Rows.Add(prms);
                        }
                ...
                Session["DataTable"] = HesapTablo;
                GridDamla.DataSource = HesapTablo;
                GridDamla.Rebind();
                ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("SNVSNCLST", HesapTablo));
                ReportViewer1.LocalReport.Refresh();
            }
            //Response.Redirect("ODS_SinavDegerlendir.aspx");
        }

        private void Hesapla2(EOBSEntities entity, SINAVLAR snv, short drs_ss, int SNV_ID, int DRS_ID, String Kitapcik, String cvpD0,  Decimal KS, String DersAdi)
        {
